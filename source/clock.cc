...
*
*              TODO: There must be a simpler way to obtain a millisecond clock,
*              but I couldn't figure it out, so therefore I wrote this file.
*              Find the proper API functions and use them directly in
*              protocol.c and delete this file.
*
*******************************************************************************
